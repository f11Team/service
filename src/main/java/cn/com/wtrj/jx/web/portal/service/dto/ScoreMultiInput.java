...
public class ScoreMultiInput implements Serializable {
	...
	private List<Map<String,String>> scoreboards;
	
	private List<Map<String,String>> scoreSingle;
	...
	public List<Map<String,String>> getScoreboards() {
		return scoreboards;
	}

	public void setScoreboards(List<Map<String,String>> scoreboards) {
	...
	public List<Map<String,String>> getScoreSingle() {
		return scoreSingle;
	}

	public void setScoreSingle(List<Map<String,String>> scoreSingle) {
